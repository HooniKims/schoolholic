...
const translations: Record<Language, Record<string, string>> = {
    ...
    en: {
        ...
        includeEnglishTranslation: 'Add English translation',
        ...
        aiError: 'Local LLM call error. Please check the API key or server status.',
